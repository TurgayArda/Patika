//
//  SearchListEbookCollectionViewCell.swift
//  SearchApp
//
...
class SearchListEbookCollectionViewCell: UICollectionViewCell {
    ...
    private func propertyUI(item: SearchList) {
        guard let name = item.trackName, let price = item.formattedPrice, let image = item.artworkUrl100 else { return }
...
extension  SearchListEbookCollectionViewCell {
