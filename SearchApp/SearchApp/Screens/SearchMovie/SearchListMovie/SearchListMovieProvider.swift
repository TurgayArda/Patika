//
//  SearchListMovieProviderr.swift
//  SearchApp
//
...
class MovieListProvider: NSObject {
    var delegate:  SearchListMovieProviderDelegate?
    var searchItem: [SearchList] = []
}

extension MovieListProvider: SearchListMovieProviderProtocol {
...
extension MovieListProvider: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: SearchListMovieCollectionViewCell.Identifier.path.rawValue, for: indexPath) as? SearchListMovieCollectionViewCell else {
